  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-4 relative">
        ...
        <h2 className="text-lg font-semibold mb-2">Ask THE DIGITAL TRADING AI</h2>
        <div className="h-64 overflow-y-auto border rounded p-2 mb-2 bg-gray-50">
          {messages.length === 0 && <div className="text-gray-400 text-center">Start a conversation with THE DIGITAL TRADING AI.</div>}
          {messages.map((msg, i) => (
