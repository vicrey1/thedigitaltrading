...
const resources = [
  ...
  },
  {
    id: 3,
    type: 'Article',
    title: 'How KYC & Security Work on THE DIGITAL TRADING',
        description: 'KYC, or Know Your Customer, is a process required by law to verify the identity of users and prevent financial crimes such as fraud and money laundering. On THE DIGITAL TRADING, you will be asked to provide personal information and upload identification documents. The process is secure and usually takes less than 24 hours. Security is a top priority at THE DIGITAL TRADING, with advanced encryption, two-factor authentication, and continuous monitoring to protect your data and funds. For your safety, always use strong, unique passwords and enable all available security features.',
    tags: ['KYC', 'Security'],
  ...
  },
  {
    id: 5,
    type: 'Video',
    title: 'Luxury Investing: The THE DIGITAL TRADING Philosophy',
  ...
  },
  {
    ...
    description: 'Compound interest means returns are reinvested, allowing growth on top of prior growth over time. This overview is educational and does not imply any guaranteed outcome.',
