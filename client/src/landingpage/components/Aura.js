    ...
    return e('section', { id: 'aura', className: 'py-20 md:py-32 bg-black/20' },
        e('div', { className: 'container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center' },
            e(InteractiveElement, { depth: 0.003, className: 'order-2 lg:order-1' },
                e('h2', { className: 'text-4xl md:text-5xl font-serif text-brand-light mb-4' }, 'The AURA Engine: AI-Assisted Research'),
                ...
                e('p', { className: 'text-brand-light/80 leading-relaxed' },
                    ...
                    e('span', { className: 'aura-style' }, 'AURA'), ' constructs predictive models that empower our strategists to act with disciplined, data-backed conviction. This is a systematic research capability for your portfolio.'
                )
            ),
