    ...
    return e('section', { className: 'min-h-screen flex items-center justify-center relative overflow-hidden', id: 'hero' },
        ...
        e('div', { className: 'container mx-auto px-6 text-center relative z-10' },
            e(InteractiveElement, { depth: 0.003 },
                ...
                e('a', { href: 'https://app.luxyield.com/register', className: 'inline-block bg-brand-accent text-brand-dark px-8 py-4 rounded-md font-bold hover:bg-yellow-300/80 transition-all duration-300 transform hover:scale-105' }, 'Create Account & Invest')
            )
        )
    );
}
