...
export default function Statements() {
  const handleDownloadPDF = () => {
    const doc = new jsPDF();
    // CRYPTO TRADING logo: 'CRYPTO' in bold orange, 'TRADING' in bold black, joined together
    doc.setFontSize(28);
    doc.setFont('helvetica', 'bold');
    // Draw 'CRYPTO' in orange, then 'TRADING' in black, joined
    ...
    doc.text('These statements summarize your deposits, withdrawals, investments, and performance for demo purposes.', 15, 52, { maxWidth: 180 });
    autoTable(doc, {
      startY: 60,
      head: [['Type', 'Details']],
      body: [
        ['Deposit', '$10,000 on 07/01/2025'],
        ['Investment', '$5,000 in Crypto Plan on 07/02/2025'],
        ['Performance Note', '$500 on 07/10/2025'],
  ...
  return (
    <div className="max-w-2xl mx-auto p-8">
      <h1 className="text-3xl font-bold mb-6 text-orange-400">Account Statements</h1>
      <div className="mb-4">
        <h2 className="text-xl font-semibold mb-2">Download Your Statements</h2>
        <p className="mb-2">You can download your simulated account statements for any period. These statements summarize your deposits, withdrawals, investments, and performance for demo purposes.</p>
      </div>
      <div className="mb-4">
        <h3 className="text-lg font-bold">Recent Activity</h3>
        <ul className="list-disc ml-6 text-gray-300">
          <li>Deposit: $10,000 on 07/01/2025</li>
          <li>Investment: $5,000 in Crypto Plan on 07/02/2025</li>
          <li>Performance Note: $500 on 07/10/2025</li>
          <li>Withdrawal: $1,000 on 07/12/2025</li>
        </ul>
      </div>
      <div className="mb-4">
        <button className="px-6 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition font-bold" onClick={handleDownloadPDF}>Download PDF</button>
      </div>
