  ...
  return (
    <div className="max-w-screen-xl mx-auto px-2 md:px-6 py-8 space-y-8">
      <div className="glass-card p-6 rounded-xl shadow-2xl border border-yellow-700 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden mb-8 w-full max-w-full">
        {/* Header */}
        <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-yellow-100 to-blue-100 border-b border-gray-200 shadow-none rounded-t-xl">
          <button
        ...
        {/* Chat messages */}
        <div className="flex-1 overflow-y-auto p-4 bg-white scrollbar-thin scrollbar-thumb-gold scrollbar-track-gray-900/60 rounded-b-xl" style={{ minHeight: 0 }}>
        ...
        {/* Chat input or session expired */}
        {sessionExpired ? (
          <div className="flex flex-col items-center justify-center p-6 bg-red-50 border-t border-gray-200 rounded-b-xl">
          ...
          <form className="flex items-center gap-2 p-4 border-t border-gray-200 bg-white rounded-b-xl" onSubmit={handleSend}>
            <input
              type="text"
